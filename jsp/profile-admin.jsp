			...
			<div class="container-fluid">
				<div class="collapse navbar-collapse" id="myNavbar">
					<ul class="nav navbar-nav">
						<li><a href="../html/clinical-admin.html">Clinical Annotation</a></li>
						<li><a href="../html/inventory-admin.html">Inventory Management</a></li>
						<li class="dropdown">
							<a href="../html/query-admin.html">Query Tool +</a>
							<ul class="dropdown-menu">
								<li><a href="../html/browser-admin.html">Data Browser</a></li>
								<li><a href="../html/sets-admin.html">Batch Sets</a></li>
								<li><a href="../html/reports-admin.html">Reports</a></li>
							</ul>
						</li>
						<li class="dropdown">
							<a href="../html/tools-admin.html">Tools +</a>
							<ul class="dropdown-menu">
								<li><a href="../html/admin-admin.html">Administration</a></li>
								<li><a href="../html/drugs-admin.html">Drug Administration</a></li>
								<li><a href="../html/orders-admin.html">Order Management</a></li>
								<li><a href="../html/protocols-admin.html">Protocols</a></li>
								<li><a href="../html/sop-admin.html">Standard Operating Procedures</a></li>
								<li><a href="../html/storage-admin.html">Storage Layout</a></li>
								<li><a href="../html/sp-admin.html">Study & Project</a></li>
								<li><a href="../html/collection-admin.html">Collection Template</a></li>
							</ul>
						</li>
					</ul>
					<ul class="nav navbar-nav navbar-right">
						<li><a href="profile-admin.jsp">
							<img src="../img/user.jpg" title="My Profile"/>
						</a></li>
						<li><a href="../html/preferences-admin.html">
